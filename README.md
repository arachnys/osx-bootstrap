...
```
curl --silent https://raw.githubusercontent.com/hazzadous/osx-bootstrap/master/install.sh | sh
```
...
* `git clone https://github.com/hazzadous/osx-bootstrap.git` to get these files locally
