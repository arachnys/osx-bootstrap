...
```
curl --silent https://raw.githubusercontent.com/arachnys/osx-bootstrap/master/install.sh | sh
```
...
* `git clone https://github.com/arachnys/osx-bootstrap.git` to get these files locally
